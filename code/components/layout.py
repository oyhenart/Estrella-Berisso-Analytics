...
def render_sidebar(base_path):
    ...
    st.sidebar.page_link("pages/1_Estadisticas.py",   label="📊 Estadísticas")
    st.sidebar.page_link("pages/2_Mapa_cancha.py",    label="🗺️ Mapa de cancha")
    st.sidebar.page_link("pages/3_Plantilla.py",      label="👥 Plantilla")
