...
# Por defecto mostramos solo la última fecha (index=1), no "Todas" (index=0),
# para no confundir con videos de partidos anteriores.
fecha_sel = st.selectbox("Filtrar por fecha", fechas, index=1)
if fecha_sel != "Todas":
